...
public interface dotListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link dotParser#attr1_stmt}.
	 * @param ctx the parse tree
	 */
	void enterAttr1_stmt(@NotNull dotParser.Attr1_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link dotParser#attr1_stmt}.
	 * @param ctx the parse tree
	 */
	void exitAttr1_stmt(@NotNull dotParser.Attr1_stmtContext ctx);
